...
public class EdgeDetectionActivity extends AppCompatActivity implements CameraBridgeViewBase.CvCameraViewListener2 {
        ...
        switch (requestCode) {
            case 1: {
                ...
                if (grantResults.length > 0
                    ...
                    Toast.makeText(EdgeDetectionActivity.this, "Permission denied to read your External storage", Toast.LENGTH_SHORT).show();
                }
                return;
            }
